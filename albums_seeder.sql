...
--        ('AC/DC', 'Back in Black', 1980, 30.1, 'Hard rock');
    ...
    VALUES ('Michael Jackson', 'Thriller', 1982, 51.2, 'Pop, post-disco, funk, rock'),
           ...
           ('Fleetwood Mac', 'Rummours', 1997, 29.3, 'Soft rock'),
           ...
           ('Alanis Morssette', 'Jagged Little Pill', 1995, 25.4, 'Alternative Rock'),
           ...
           ('Bob Marley & The Wailers', 'Legend: The Best of Bob Marley & The Wailers', 1984, 22.9, 'Raggae'),
